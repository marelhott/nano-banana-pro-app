...
export const Header: React.FC<HeaderProps> = ({ onSettingsClick }) => {
  return (
    <div className="flex items-center justify-between gap-3 bg-ink px-6 py-5 w-full select-none shrink-0">
      ...
      {onSettingsClick && (
        ...
        >
          <svg className="w-6 h-6 text-monstera-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
