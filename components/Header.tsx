  ...
  return (
    <div className="flex items-center justify-between gap-3 bg-[var(--bg-main)] border-b border-[var(--border-color)] px-6 py-4 w-full select-none shrink-0 transition-colors duration-300">
      ...
      <div className="flex items-center gap-3">
        ...
        <h1 className="text-lg md:text-xl font-serif font-bold text-[var(--text-primary)] tracking-tight leading-none whitespace-nowrap">
          Mulen nano
        </h1>
      </div>
      ...
      <div className="flex items-center gap-4">
        ...
        {onSettingsClick && (
          <button
            ...
            className="p-2 hover:bg-[var(--bg-panel)] rounded-md transition-colors text-[var(--text-secondary)] hover:text-[var(--text-primary)]"
            title="Settings"
          >
