...
export const LoadingProgress: React.FC<LoadingProgressProps> = ({
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 bg-[#101210] border border-[#a8bf8f]/30 rounded-lg shadow-2xl p-4 min-w-[300px] animate-fadeIn">
      <div className="space-y-3">
        {/* Header */}
        <div className="flex items-center gap-2">
          <svg className="w-5 h-5 text-[#a8bf8f] animate-spin" fill="none" viewBox="0 0 24 24">
          ...
          <div className="text-xl font-[900] text-[#a8bf8f]">
            {percentage}%
          </div>
        </div>
        ...
        <div className="relative w-full h-2.5 bg-gray-800 rounded-full overflow-hidden">
          <div
            className="absolute inset-y-0 left-0 bg-[#a8bf8f] rounded-full transition-all duration-500"
